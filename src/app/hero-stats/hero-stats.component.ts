...
export class HeroStatsComponent implements OnInit , AfterViewInit{
  ...
  findPictureURL(nummer1: number){
    return "https://steamcdn-a.akamaihd.net/apps/dota2/images/dota_react/heroes/"+this.idToNameFuntion(nummer1)+".png?"
  }



  idToNameFuntion(heroId: number){
    const found = this.heroList.find(element => element.id == heroId)
    return (found!.name.substring(14))
  }
